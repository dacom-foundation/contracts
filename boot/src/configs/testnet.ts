...
export default {
  network: {
    protocol: 'https',
    host: 'testnet.copenomics.world',
    port: ':443/api',
  },
  default_public_key: 'EOS7izAK61zDPbdUTyNxGfC78XxejdjzXTjixETNrhdDxHdP2SKKb',
  system: 'eosio',
  provider,
  provider_chairman,
  private_keys: [
    '5JpDwYhsiMQP7hbSMRF5PSND75ompB1Y24oUofs29KHooDak77Q',
  ],
  emission: {
