const network = {
  protocol: 'https',
  host: 'voskhod.coopenomics.world',
  port: ':443/api',
}
...
const public_key = 'EOS7TjqL5YfQ7tKzzKr3i1Pa1JkTVrcY2BJhMFfyMPajfAiPThjH7'
const private_key = '5Jji9xD8DrhPf9kB8BNvhhnoVXVFQSTdPVP3DaDvBpqFjvNUEUZ'
